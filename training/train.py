...
class CPCTrainer(Trainer):
    def __init__(self, mntp_loss_weight, sc_loss_weight, *args, **kwargs):
        ...
        self.mntp_loss_weight = mntp_loss_weight  # MNTP(Masked Next Token Prediction)损失权重
        self.sc_loss_weight = sc_loss_weight  # SC(Sentence Contrastive)损失权重
...
def main():
    ...
    if training_args.do_train:
        ...
        logger.info("Skipping training. Loading final checkpoint for evaluation.")
